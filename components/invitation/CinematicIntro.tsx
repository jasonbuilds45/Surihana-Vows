 ...
 *   Scene 2 — Both names together in a two-column grid split by a vertical
 *             rose hairline. Ampersand floats at the intersection.
 *   Scene 3 — Date. Each word at large scale — the month full-white, day/year
 *             dimmer, like a departure board.
 *   Scene 4 — Venue. Italic, bottom-anchored, fills the lower third.
 *   Scene 5 — Countdown. Three columns. Days bright, Hours/Min dim.
 *
 * PHASE 2 · THE LOCKED PANEL
 *   Hero photo full-bleed behind frosted glass panels split horizontally.
 *   Monogram lockup in a precise square with hairline borders.
 *   Single underlined text link "Open your invitation" — no button.
 *   Click: panels slide apart revealing the photo.
 *
 * PHASE 3 · UNVEIL
 *   Full-bleed photo. Dark overlay. White lightface type at extreme scale.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
// ── Countdown hook ─────────────────────────────────────────────────────────
// Fix: capture `target` into a local `const t` so TypeScript sees
// the narrowed `string` type inside the `tick` closure, not `string | undefined`.
function useCountdown(target?: string) {
  const [vals, setVals] = useState({ d: 0, h: 0, m: 0, label: "" });
  useEffect(() => {
    if (!target) return;
    const t: string = target; // ← narrowed; safe inside closure
    function tick() {
    ...
    <>
      <style>{`
        ...
        .uv-link {
          ...
          padding:0 0 3px 0;background:none;border:none;
      ...
      {phase === "title" && (
        ...
        >
          ...
          <div style={{
            ...
            {scene === 0 && (
              <div>
                ...
                <h1 className="t-name-solo" style={{
                  ...
                  fontWeight: 300, lineHeight: .88, letterSpacing: "-.035em",
            ...
            {scene === 1 && (
              <div style={{ textAlign: "right" }}>
                ...
                <div style={{
                  marginTop: "clamp(1.5rem,4vh,3rem)",
                  width: "min(90px,20%)", height: 1, marginLeft: "auto",
            ...
            {/* Scene 2 — Both names split by vertical rose line */}
            {scene === 2 && (
              <div style={{ position: "relative" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0 }}>
                  <div style={{ paddingRight: "clamp(1.5rem,4vw,3rem)" }}>
                    <h1 className="t-name-pair" style={{
                      fontFamily: DF, fontSize: "clamp(4.5rem,12vw,10rem)",
              ...
              <div>
                ...
                {weddingDate && (
                  <div style={{ opacity: 0, animation: "ci-in-up 1.0s .2s cubic-bezier(.16,1,.3,1) forwards" }}>
                    <div style={{ display: "flex", alignItems: "baseline", gap: "clamp(.75rem,2.5vw,2rem)" }}>
                  ...
                  {[
                    ...
                    <div key={label}>
                      <div style={{
                        ...
                        color: hi ? "#FFFFFF" : "rgba(255,255,255,.32)",
                      }}>
                        {pad(n)}
                      </div>
                      <div style={{
                        ...
                        color: hi ? "rgba(190,45,69,.7)" : "rgba(255,255,255,.18)",
                        fontWeight: 600,
                      }}>
                        {label}
                      </div>
          ...
          <div style={{
            position: "absolute",
            bottom: "clamp(28px,4.5vh,46px)", right: "clamp(32px,6vw,88px)",
      ...
      {phase === "panel" && (
        ...
        >
          ...
          {/* Skip */}
          <button type="button" onClick={openInvite} className="ci-ctrl" style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                fontFamily: BF, fontSize: ".5rem",
                letterSpacing: ".52em", textTransform: "uppercase",
                color: INK_3, fontWeight: 600, marginBottom: ".5rem",
              }}>
            ...
            {/* Monogram lockup */}
            <div style={{ opacity: 0, animation: "ci-mono-in 1.1s .6s cubic-bezier(.34,1.56,.64,1) forwards" }}>
              <div style={{
                position: "relative",
                width: "clamp(140px,25vw,188px)", height: "clamp(140px,25vw,188px)",
                border: "1px solid rgba(190,45,69,.28)",
              }}>
                {/* Inner square */}
                <div style={{ position: "absolute", inset: 8, border: "1px solid rgba(168,120,8,.18)" }} />
                {/* Corner marks */}
                {([
                  { top: -3, left: -3 }, { top: -3, right: -3 },
                  { bottom: -3, left: -3 }, { bottom: -3, right: -3 },
                ] as React.CSSProperties[]).map((pos, i) => (
                  <div key={i} style={{ position: "absolute", ...pos, width: 5, height: 5, background: ROSE }} />
                ))}
                {/* Initials */}
                <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <span style={{
                    ...
                    letterSpacing: ".18em", color: INK, lineHeight: 1,
                    marginLeft: ".18em",
                  }}>
                    {initials}
                  </span>
            ...
            {/* Date + venue */}
            <div style={{
              textAlign: "center", marginTop: "clamp(2rem,4vh,3.5rem)",
              ...
              {weddingDate && countdown.label && (
                <div style={{
                  ...
                  marginTop: ".875rem", padding: "5px 16px", borderRadius: 999,
                  background: "rgba(190,45,69,.06)", border: "1px solid rgba(190,45,69,.12)",
                }}>
                  <span style={{
                    width: 5, height: 5, borderRadius: "50%",
                    background: ROSE, flexShrink: 0, boxShadow: `0 0 6px ${ROSE}`,
                  }} />
                  <span style={{
                    fontFamily: BF, fontSize: ".62rem",
            ...
            <div style={{
              ...
              >
                {ripple && (
                  <span key={ripple.k} aria-hidden style={{
          ...
          >
            ...
            <div aria-hidden style={{
              ...
              background: `linear-gradient(to bottom,
                rgba(8,5,7,.70) 0%, rgba(8,5,7,.30) 30%,
                rgba(8,5,7,.28) 60%, rgba(8,5,7,.78) 100%)`,
            }} />
            <div aria-hidden style={{
            ...
            <div style={{ position: "relative", zIndex: 5, padding: "7rem 1.5rem 9rem", maxWidth: 800, width: "100%" }}>
              ...
              <h1 className="u1 uv-name" style={{
                fontFamily: DF, fontSize: "clamp(4.5rem,14vw,11rem)",
                fontWeight: 300, lineHeight: .84, letterSpacing: "-.04em",
                color: "#FFFFFF", marginBottom: ".06em",
              }}>
                {brideFirst}
              </h1>
              ...
              <p className="u2" style={{
                ...
                color: "rgba(190,45,69,.80)", letterSpacing: ".12em", lineHeight: 1.2,
                marginBottom: ".06em",
              }}>
                &amp;
              </p>
              ...
              <h1 className="u3 uv-name" style={{
                fontFamily: DF, fontSize: "clamp(4.5rem,14vw,11rem)",
                fontWeight: 300, lineHeight: .84, letterSpacing: "-.04em",
                color: "rgba(232,188,20,.88)", marginBottom: "2.25rem",
              }}>
                {groomFirst}
              </h1>
              ...
              <div className="u5" style={{
                ...
                justifyContent: "center", gap: ".6rem", marginBottom: "1.5rem",
              }}>
                {weddingDate && (
                  <span style={{ fontFamily: BF, fontSize: ".85rem", fontWeight: 500, color: "rgba(255,255,255,.85)", letterSpacing: ".06em" }}>
                    {weddingDate}
                  </span>
                )}
                {venueName && (
                  <>
                    ...
                    <span style={{ fontFamily: BF, fontSize: ".82rem", color: "rgba(255,255,255,.55)", letterSpacing: ".04em" }}>{venueName}</span>
                  </>
                )}
                {venueCity && (
                  <>
                    <span aria-hidden style={{ width: 3, height: 3, borderRadius: "50%", background: "rgba(190,45,69,.35)", display: "inline-block" }} />
                    <span style={{ fontFamily: BF, fontSize: ".82rem", color: "rgba(255,255,255,.38)", letterSpacing: ".04em" }}>{venueCity}</span>
                  </>
                )}
              </div>
              ...
              <div className="u6" style={{ marginBottom: "2.75rem" }}>
                <span style={{
                  ...
                  color: "rgba(255,255,255,.65)", letterSpacing: ".03em",
                }}>
              ...
              <div className="u7">
                <a href="#invite-content" className="uv-link">View invitation</a>
              </div>
            </div>
            ...
            <div style={{
              ...
              zIndex: 5, animation: "ci-bounce 2.5s 2.5s ease-in-out infinite",
            }}>
              <span style={{ fontFamily: BF, fontSize: ".42rem", letterSpacing: ".44em", textTransform: "uppercase", color: "rgba(255,255,255,.28)" }}>
                Scroll
              </span>
