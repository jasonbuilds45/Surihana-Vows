        ...
        <div className="shell" style={{ marginTop:"clamp(1.2rem,2.5vh,1.8rem)" }}>
          ...
          <div className="quote-wrap c-r3" style={{ marginBottom:"clamp(1.6rem,3vh,2.2rem)" }}>
            <svg style={{position:"absolute",top:8,left:8}} width="13" height="13"
              ...
              <path d="M12 1H1V12" stroke="#BE2D45" strokeWidth="1.2" strokeLinecap="round" opacity=".40"/>
            </svg>
            <svg style={{position:"absolute",bottom:8,right:8}} width="13" height="13"
              viewBox="0 0 13 13" fill="none" aria-hidden>
              <path d="M1 12H12V1" stroke="#BE2D45" strokeWidth="1.2" strokeLinecap="round" opacity=".40"/>
            </svg>
          ...
          <div className="c-r4" style={{
            ...
            <div style={{flex:1,height:1,background:"linear-gradient(90deg,transparent,var(--bdr-md))"}} />
            <span className="div-lbl" style={{
              fontFamily:"var(--font-body)",
              fontSize:".42rem", letterSpacing:".42em",
              textTransform:"uppercase", color:"var(--ink-3)", fontWeight:600,
            }}>Private access</span>
            <div style={{flex:1,height:1,background:"linear-gradient(90deg,var(--bdr-md),transparent)"}} />
          </div>
          ...
          <div className="btn-row c-r5">
            ...
            <a href="/login?hint=couple&redirect=/admin" className="btn-p">
              <div className="btn-text">
                <span className="btn-ey" style={{color:"rgba(255,255,255,.55)"}}>The couple</span>
                <span className="btn-lb" style={{color:"#FFFFFF"}}>{bf} &amp; {gf}</span>
              </div>
            ...
            <a href="/login?hint=vault&redirect=/family" className="btn-s">
              <div className="btn-text">
                <span className="btn-ey" style={{color:"var(--ink-3)"}}>Family vault</span>
                <span className="btn-lb" style={{color:"var(--rose)"}}>Family login</span>
              </div>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none"
                stroke="var(--rose)" strokeWidth="2"
                strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0,opacity:.60}}>
                <path d="M5 12h14M12 5l7 7-7 7"/>
              </svg>
            </a>
